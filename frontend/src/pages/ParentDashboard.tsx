        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
                    ...
                    childLocations.map((child) => (
                      <div key={child.id} className="flex items-center justify-between p-2 bg-background rounded-lg">
                        <div className="flex items-center gap-2">
                          <div className={`w-3 h-3 rounded-full ${child.status === 'safe' ? 'bg-green-500' :
              ...
              {/* Alerts */}
              <div className="bg-card rounded-2xl shadow-depth p-4 overflow-y-auto auto h-[100px] w-full ">
                <h3 className="font-bold text-foreground mb-3 flex items-center gap-2">
                  <span>🔔</span> Alerts
                </h3>
                <div className="space-y-2">
