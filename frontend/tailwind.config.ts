  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "dash-dark": "hsl(var(--dashboard-dark))",
        "dash-surface": "hsl(var(--sidebar-accent))",
        sidebar: {
        ...
        emergency: { DEFAULT: "hsl(var(--emergency))", foreground: "hsl(var(--emergency-foreground))" },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        depth: "0 0 0 1px rgba(0,0,0,.05), 0 2px 4px rgba(0,0,0,.05), 0 12px 24px rgba(0,0,0,.05)",
      },
      keyframes: {
